class Booking < ApplicationRecord
  ...
  scope :completed, -> { where.not(ticket_number: nil).where.not(ticket_number: "") }
  ...
  scope :payment_due, -> { where(recipt_number: nil).where.not(recipt_number: "") }
  scope :pending, -> { where(ticket_number: nil).where(ticket_number: "") }
